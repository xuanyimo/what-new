package cn.dubby.what.volleyx.cache;
...
import cn.dubby.what.utils.MD5Utils;

/**
 * Created by dubby on 16/5/31.
 */
public class ImageCacheUtil implements ImageLoader.ImageCache {
    ...
    public ImageCacheUtil() {
        ...
        try {
            // 获取DiskLruCahce对象
            mDiskLruCache = DiskLruCache.open(getDiskCacheDir(MyApplication.context, "Rabbit"), getAppVersion(MyApplication.context), 1, DISKMAXSIZE);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        return new File("/data/data/cn.dubby.what/cache/Rabbit");
//        String cachePath;
